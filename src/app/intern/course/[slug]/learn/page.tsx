          ...
          <div className="w-full xl:flex-grow xl:min-w-0 flex flex-col overflow-hidden bg-white">
            ...
            <div className="relative w-full pb-[56.25%] h-0">
              {activeLesson.content_type === "video" ? (
                ...
                <div className="absolute inset-0 bg-gray-100/60 overflow-y-scroll  overflow-x-hidden">
                  ...
                  {!activeLesson.isCompleted &&
                    !completedLessons.has(activeLesson.id) && (
                      <div className="sticky bottom-0 left-0 w-full bg-gradient-to-t from-white/90 to-transparent px-5 py-4 z-20">
