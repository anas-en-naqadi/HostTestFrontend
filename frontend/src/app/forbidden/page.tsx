...
export default function NotFound1() {
  const [user, setUser] = useState<null | Record<string, number>>(null);
...
You tried to access a page you did not have prior authorization for.          </p>
          <Link
            href={destination}
            className="flex items-center space-x-2 bg-[#136A86] hover:bg-[#5CB5BD] text-gray-100 px-4 py-2 mt-12 rounded transition duration-150"
            title="Return Home"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
