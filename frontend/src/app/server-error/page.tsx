...
export default function ServerError() {
  ...
  if (user) {
    if (user.role === "intern") destination = "/intern/home";
    else destination = `/${user.role}/dashboard`;
  } else destination = "/login";
  return (
    <div className="w-full flex flex-col h-screen m-auto items-center justify-center overflow-auto">
      <div className="w-full h-screen -mt-12  flex flex-col items-center justify-center">
        <svg
          className="w-full xl:1/2 md:w-1/3 lg:w-1/4 text-blue-600"
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-red-600 mt-8">
            500
          </p>
        ...
        <Link
          href={destination}
          className="flex items-center space-x-2 gap-2  bg-red-600 mt-8  hover:bg-red-700 text-gray-100 px-4 py-2 rounded transition duration-150"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
